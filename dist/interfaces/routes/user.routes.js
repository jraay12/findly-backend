...
router.get("/getUser", auth_middleware_1.authenticateJWT, user_controller_1.default.getUser);
router.post("/loginUser", user_controller_1.default.loginUser);
router.patch("/updateStatus/:id", auth_middleware_1.authenticateJWT, user_controller_1.default.updateUserStatus);
router.get("/verify", user_controller_1.default.verify);
router.get("/getUserInformation", auth_middleware_1.authenticateJWT, user_controller_1.default.getUserInformation);
router.patch('/updateUserInformation', auth_middleware_1.authenticateJWT, user_controller_1.default.updateUserInformation);
