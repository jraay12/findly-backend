...
const item_contrtoller_1 = __importDefault(require("../controllers/item.contrtoller"));
const auth_middleware_1 = require("../../middleware/auth.middleware");
const router = (0, express_1.Router)();
const multerConfig_1 = require("../../infrastructure/upload/multerConfig");
/**
 * @swagger
 ...
 *                   example: "Internal server error"
 */
router.post("/createUserItem", auth_middleware_1.authenticateJWT, multerConfig_1.multerUpload.single("image"), item_contrtoller_1.default.createUserItem);
router.get("/userItemLost", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.getUserLostItem);
router.put("/update-status/:id", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.updateItemStatus);
router.get("/getAllUserItem", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.getAllUserItem);
router.patch("/update-item/:id", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.updateUserItem);
router.get("/get-specific-item/:id", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.getSpecificItem);
router.get("/get-specific-token-item/:token", item_contrtoller_1.default.getSpecificItemByToken);
router.get("/send-qr-notification/:token", item_contrtoller_1.default.sendQRNotification);
router.delete("/delete-item/:id", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.deleteItem);
router.post("/createAdminItem", auth_middleware_1.authenticateJWT, multerConfig_1.multerUpload.single("image"), item_contrtoller_1.default.createAdminItem);
router.get("/getAdminItem", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.getAdminItem);
router.post("/updateAdminItemStatus/:id", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.updateAdminItemStatus);
router.patch("/updateAdminItem/:id", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.updateAdminItem);
router.post("/createOrder", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.createOrder);
router.get("/getOrder", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.getOrder);
router.post("/submitReport/:token", item_contrtoller_1.default.submitReport);
router.post("/order-toggle/:id", auth_middleware_1.authenticateJWT, item_contrtoller_1.default.orderToggle);
